...
<table>
  ...
  <tr>
    <td>MySQL 数据库应用、RemoteApp 远程应用:blossom: </td>
  </tr>
  <tr>
    <td>动作授权</td>
  ...
  <tr>
    <td>支持对 RemoteApp:blossom:、MySQL 等应用操作的录像进行回放审计</td>
  </tr>
  <tr>
    <td>指令审计</td>
  ...
  <tr>
    <td>Oracle :blossom:</td>
  </tr>
  <tr>
    <td>MariaDB :blossom:</td>
  </tr>
  <tr>
    <td>PostgreSQL :blossom:</td>
  </tr>
  <tr>
...
**说明**: 带 :blossom: 后缀的是 X-PACK 插件有的功能
