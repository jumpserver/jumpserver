...
<table>
  ...
  <tr>
    <td>MySQL 数据库应用、RemoteApp 远程应用:rose: </td>
  </tr>
  <tr>
    <td>动作授权</td>
  ...
  <tr>
    <td>支持对 RemoteApp:rose:、MySQL 等应用操作的录像进行回放审计</td>
  </tr>
  <tr>
    <td>指令审计</td>
