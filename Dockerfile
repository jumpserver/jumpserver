...
RUN cd /tmp/requirements && pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade pip setuptools && pip install -i https://pypi.tuna.tsinghua.edu.cn/simple  wheel && \
