...
<table width="100%">
  <thead>
    <tr>
      <th width="20%" align="left">项目</th>
      <th width="16%" align="center"><div align="center">版本</div></th>
      <th width="64%" align="center"><div align="center">说明</div></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td width="64%" align="left">开源特权访问管理平台</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer Web 界面</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer Web 终端与原生客户端</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer 通用协议连接器与代理</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer Web 数据库连接器</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer AI 组件</td>
    </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td width="16%" align="center"><div align="center"><img src="https://img.shields.io/badge/tag-private-red" alt="私有版本" /></div></td>
      <td width="64%" align="left">JumpServer 企业版会话录像转码服务</td>
    </tr>
    <tr>
      <td width="20%" align="left" nowrap><a href="https://github.com/jumpserver/jdmc">JDMC</a></td>
      <td width="16%" align="center"><div align="center"><img src="https://img.shields.io/badge/tag-private-red" alt="私有版本" /></div></td>
      <td width="64%" align="left">JumpServer 企业版主机运维与管理服务</td>
    </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td width="64%" align="left">JumpServer 安装与管理工具</td>
    </tr>
    <tr>
      ...
      <td width="64%" align="left">JumpServer Web 网关与静态资源</td>
    </tr>
  </tbody>
</table>
