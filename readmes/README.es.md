...
Accede a JumpServer en tu navegador en `http://tu-ip-de-jumpserver/`
...
|--------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| [Lina](https://github.com/jumpserver/lina)             | <a href="https://github.com/jumpserver/lina/releases"><img alt="Lina release" src="https://img.shields.io/github/release/jumpserver/lina.svg" /></a>                   | Interfaz Web de JumpServer                                                                                       |
...
| [KoKo](https://github.com/jumpserver/koko)             | <a href="https://github.com/jumpserver/koko/releases"><img alt="Koko release" src="https://img.shields.io/github/release/jumpserver/koko.svg" /></a>                   | Conector del Protocolo de Caracteres de JumpServer                                                                 |
...
JumpServer es un producto crítico para la misión. Consulta las Recomendaciones de Seguridad Básicas para la instalación y el despliegue. Si encuentras algún problema relacionado con la seguridad, por favor contáctanos directamente:
