...
from apps.jumpserver.settings.auth import AUTHENTICATION_BACKENDS_JUMP_METHOD_THIRD_PARTY
...
def on_user_auth_login_success(sender, user, request, **kwargs):
    ...
    if request.session.get('auth_backend') in AUTHENTICATION_BACKENDS_JUMP_METHOD_THIRD_PARTY:
