...
extra_nodes_data = [
    ...
    {"id": "credential_policy_node", "name": _("Credential policy"), "pId": "view_pam"},
...
special_pid_mapper = {
    ...
    'accounts.credentialpolicy': 'credential_policy_node',
    'accounts.credentialpolicyversion': 'credential_policy_node',
    'accounts.credentialissuerequest': 'credential_policy_node',
    'accounts.credentiallease': 'credential_policy_node',
