# Generated by Django 3.1.12 on 2021-09-06 11:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='Date updated')),
                ('verify_code', models.CharField(max_length=16, verbose_name='Verify code')),
                ('date_joined', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Date start')),
                ('date_left', models.DateTimeField(db_index=True, null=True, verbose_name='Date end')),
