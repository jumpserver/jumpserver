...
urlpatterns = [
    ...
    url(r'^apply-perms/', include('apply_perms.urls.views_urls', namespace='apply-perms')),
    ...
    url(r'^api/apply-perms/', include('apply_perms.urls.api_urls', namespace='api-apply-perms')),
