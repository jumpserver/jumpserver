...
api_v1 = [
    ...
    path('access-controls/', include('access_control.urls.api_urls', namespace='api-access-control'))
]
...
app_view_patterns = [
    ...
    path('access-control/', include('access_control.urls.view_urls', namespace='access-controls')),
