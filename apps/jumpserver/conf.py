...
class Config(dict):
    ...
    defaults = {
        ...
        'PERM_EXPIRED_SHORT_NOTICE_MINUTES': 15,
        ...
        'CHAT_AI_EXTERNAL_MODELS_ALLOWED': True,
        'CHAT_AI_CORE_BASE_URL': 'http://127.0.0.1:8080',
        'CHAT_AI_CORE_TLS_VERIFY': True,
        'CHAT_AI_CORE_CA_CERT': '',
        'CHAT_AI_CORE_CLIENT_CERT': '',
        'CHAT_AI_CORE_CLIENT_KEY': '',
        ...
        'CHAT_AI_SCHEMA_CACHE_TTL': 3600,
        'CHAT_AI_SCHEMA_LOAD_ON_START': False,
        'CHAT_AI_HISTORY_MESSAGES': 30,
        ...
        'CHAT_AI_METHOD_POLICIES': {
            'GET': {'enabled': True, 'approval': False, 'risk_level': 'read'},
