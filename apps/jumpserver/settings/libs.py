...
OAUTH2_PROVIDER_ACCESS_TOKEN_EXPIRE_SECONDS = CONFIG.OAUTH2_PROVIDER_ACCESS_TOKEN_EXPIRE_SECONDS
OAUTH2_PROVIDER_REFRESH_TOKEN_EXPIRE_SECONDS = CONFIG.OAUTH2_PROVIDER_REFRESH_TOKEN_EXPIRE_SECONDS
OAUTH2_PROVIDER = {
    'ALLOWED_REDIRECT_URI_SCHEMES': ['https', 'jms'],
    'PKCE_REQUIRED': True,
    'ACCESS_TOKEN_EXPIRE_SECONDS': OAUTH2_PROVIDER_ACCESS_TOKEN_EXPIRE_SECONDS,
    'REFRESH_TOKEN_EXPIRE_SECONDS': OAUTH2_PROVIDER_REFRESH_TOKEN_EXPIRE_SECONDS,
}
