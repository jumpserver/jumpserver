...
SAML2_IDP_METADATA_URL = CONFIG.SAML2_IDP_METADATA_URL
SAML2_IDP_METADATA_XML = CONFIG.SAML2_IDP_METADATA_XML
SAML2_IDP_METADATA_CERT_VERIFY_MODE = CONFIG.SAML2_IDP_METADATA_CERT_VERIFY_MODE
SAML2_IDP_METADATA_CACERT_CONTENT = CONFIG.SAML2_IDP_METADATA_CACERT_CONTENT
...
AUTH_OAUTH2_CERT_VERIFY_MODE = CONFIG.AUTH_OAUTH2_CERT_VERIFY_MODE
AUTH_OAUTH2_CACERT_CONTENT = CONFIG.AUTH_OAUTH2_CACERT_CONTENT
...
VAULT_OPENBAO_ADDR = CONFIG.VAULT_OPENBAO_ADDR
VAULT_OPENBAO_TOKEN = CONFIG.VAULT_OPENBAO_TOKEN
VAULT_OPENBAO_MOUNT_POINT = CONFIG.VAULT_OPENBAO_MOUNT_POINT
VAULT_OPENBAO_TIMEOUT = CONFIG.VAULT_OPENBAO_TIMEOUT
VAULT_OPENBAO_VERIFY_TLS = CONFIG.VAULT_OPENBAO_VERIFY_TLS
VAULT_OPENBAO_CACERT_CONTENT = CONFIG.VAULT_OPENBAO_CACERT_CONTENT
VAULT_OPENBAO_CACERT_FILE = CONFIG.VAULT_OPENBAO_CACERT_FILE

SSH_CA_ENABLED = CONFIG.SSH_CA_ENABLED
SSH_CA_OPENBAO_ADDR = CONFIG.SSH_CA_OPENBAO_ADDR
SSH_CA_OPENBAO_TOKEN = CONFIG.SSH_CA_OPENBAO_TOKEN
SSH_CA_OPENBAO_MOUNT_POINT = CONFIG.SSH_CA_OPENBAO_MOUNT_POINT
SSH_CA_OPENBAO_ROLE = CONFIG.SSH_CA_OPENBAO_ROLE
SSH_CA_OPENBAO_TTL = CONFIG.SSH_CA_OPENBAO_TTL
SSH_CA_OPENBAO_TIMEOUT = CONFIG.SSH_CA_OPENBAO_TIMEOUT
SSH_CA_OPENBAO_VERIFY_TLS = CONFIG.SSH_CA_OPENBAO_VERIFY_TLS
SSH_CA_OPENBAO_CACERT_FILE = CONFIG.SSH_CA_OPENBAO_CACERT_FILE
SSH_CA_OPENBAO_SOURCE_ADDRESS = CONFIG.SSH_CA_OPENBAO_SOURCE_ADDRESS
...
FACE_RECOGNITION_IDENTITY_THRESHOLD = CONFIG.FACE_RECOGNITION_IDENTITY_THRESHOLD
FACE_RECOGNITION_DEVICE = CONFIG.FACE_RECOGNITION_DEVICE
FACE_RECOGNITION_PROVIDERS = CONFIG.FACE_RECOGNITION_PROVIDERS
FACE_RECOGNITION_DETECTION_SIZE = CONFIG.FACE_RECOGNITION_DETECTION_SIZE
FACE_RECOGNITION_MAX_FACES = CONFIG.FACE_RECOGNITION_MAX_FACES
FACE_RECOGNITION_MIN_FACE_RATIO = CONFIG.FACE_RECOGNITION_MIN_FACE_RATIO
FACE_RECOGNITION_CAPTURE_TIMEOUT = CONFIG.FACE_RECOGNITION_CAPTURE_TIMEOUT
FACE_RECOGNITION_ENROLLMENT_SAMPLES = CONFIG.FACE_RECOGNITION_ENROLLMENT_SAMPLES
FACE_RECOGNITION_FRAME_MAX_BYTES = CONFIG.FACE_RECOGNITION_FRAME_MAX_BYTES
FACE_RECOGNITION_FRAME_MIN_INTERVAL = CONFIG.FACE_RECOGNITION_FRAME_MIN_INTERVAL
FACE_RECOGNITION_DEBUG = CONFIG.FACE_RECOGNITION_DEBUG
FACE_MONITOR_GRACE_SECONDS = max(1, min(int(CONFIG.FACE_MONITOR_GRACE_SECONDS), 300))
INSIGHTFACE_MODEL_ROOT = os.path.expanduser(CONFIG.INSIGHTFACE_MODEL_ROOT)
INSIGHTFACE_MODEL_NAME = CONFIG.INSIGHTFACE_MODEL_NAME
FACE_LIVENESS_MODE = CONFIG.FACE_LIVENESS_MODE
FACE_LIVENESS_THRESHOLD = CONFIG.FACE_LIVENESS_THRESHOLD
FACE_LIVENESS_MODEL_PATH = os.path.expanduser(CONFIG.FACE_LIVENESS_MODEL_PATH)
FACE_LIVENESS_LIVE_INDEX = CONFIG.FACE_LIVENESS_LIVE_INDEX
FACE_LIVENESS_MIN_MOTION = CONFIG.FACE_LIVENESS_MIN_MOTION
FACE_LIVENESS_MIN_TEXTURE = CONFIG.FACE_LIVENESS_MIN_TEXTURE
FACE_LIVENESS_MIN_FACE_SIZE = CONFIG.FACE_LIVENESS_MIN_FACE_SIZE
FACE_LIVENESS_CHALLENGE_TIMEOUT = CONFIG.FACE_LIVENESS_CHALLENGE_TIMEOUT
