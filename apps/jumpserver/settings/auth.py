...
AUTH_CERT_VENDOR = CONFIG.AUTH_CERT_VENDOR
AUTH_CERT_ENROLL_ENABLED = CONFIG.AUTH_CERT_ENROLL_ENABLED
AUTH_CERT_ENROLL_VALIDITY_DAYS = CONFIG.AUTH_CERT_ENROLL_VALIDITY_DAYS
AUTH_CERT_CHALLENGE_TTL = CONFIG.AUTH_CERT_CHALLENGE_TTL
AUTH_CERT_DEFAULT_PIN = CONFIG.AUTH_CERT_DEFAULT_PIN
