...
ADMIN_USER_SECURITY_MFA_AUTH = CONFIG.ADMIN_USER_SECURITY_MFA_AUTH
...
ADMIN_USER_SECURITY_PASSWORD_MIN_LENGTH = CONFIG.ADMIN_USER_SECURITY_PASSWORD_MIN_LENGTH  # Unit: bit
