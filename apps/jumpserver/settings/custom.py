...
# Enable send alert email when an insecure command created
SEND_COMMAND_ALERT_EMAIL_ENABLED = CONFIG.SEND_COMMAND_ALERT_EMAIL_ENABLED

INSECURE_COMMAND_LEVEL = CONFIG.INSECURE_COMMAND_LEVEL
