...
urlpatterns = [
    ...
    url(r'^asset/(?P<pk>[0-9a-zA-Z\-]{36})/more_detail/(?P<node>[0-9]+)$', views.AssetMoreDetailView.as_view(), name='asset-more-detail'),
    url(r'^asset/(?P<pk>[0-9a-zA-Z\-]{36})/more_detail/update$', views.asset_more_detail_update, name='asset-more-detail1-update'),
