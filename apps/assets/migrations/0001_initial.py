    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_private_key', models.CharField(blank=True, max_length=4096, null=True, validators=[assets.models.user.private_key_validator], verbose_name='SSH private key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_private_key', models.CharField(blank=True, max_length=8192, verbose_name='SSH private key')),
                ('_public_key', models.CharField(blank=True, max_length=8192, verbose_name='SSH public key')),
                ('auth_method', models.CharField(choices=[('P', 'Password'), ('K', 'Public key')], default='K', max_length=1, verbose_name='Auth method')),
                ('auto_push', models.BooleanField(default=True, verbose_name='Auto push')),
                ('sudo', models.TextField(default='/sbin/ifconfig', max_length=4096, verbose_name='Sudo')),
