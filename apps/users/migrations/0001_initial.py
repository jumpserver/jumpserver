    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', common.db.fields.EncryptCharField(blank=True, max_length=256, null=True, verbose_name='Secret key')),
                ...
                ('source', models.CharField(choices=[('local', 'Local'), ('ldap', 'LDAP/AD'), ('openid', 'OpenID'), ('radius', 'Radius'), ('cas', 'CAS'), ('saml2', 'SAML2'), ('oauth2', 'OAuth2'), ('custom', 'Custom')], default='local', max_length=30, verbose_name='Source')),
                ...
                ('wecom_id', models.CharField(default=None, max_length=128, null=True, unique=True, verbose_name='WeCom')),
                ('dingtalk_id', models.CharField(default=None, max_length=128, null=True, unique=True, verbose_name='DingTalk')),
                ('feishu_id', models.CharField(default=None, max_length=128, null=True, unique=True, verbose_name='FeiShu')),
            ],
            options={
                'verbose_name': 'User',
                'ordering': ['username'],
