...
class OrganizationMember(models.Model):
    ...
    _role = models.CharField(max_length=16, choices=ROLE.choices, default=ROLE.USER, verbose_name=_("Role"))
    role = models.ForeignKey('rbac.Role', limit_choices_to={'scope': 'org'}, on_delete=models.CASCADE, null=True)
