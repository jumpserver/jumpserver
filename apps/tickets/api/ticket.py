...
from tickets.const import TicketApproveLevelChoices, TicketActionChoices
...
class TicketViewSet(CommonApiMixin, viewsets.ModelViewSet):
    ...
    # ]
    filterset_fields = [
        'id', 'title', 'type', 'approve_level', 'status', 'applicant', 'applicant_display'
    ]
    search_fields = [
...
class TemplateViewSet(CommonApiMixin, viewsets.ModelViewSet):
    permission_classes = (IsValidUser,)
