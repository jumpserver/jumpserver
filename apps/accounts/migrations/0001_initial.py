    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('os', 'Operation System'), ('database', 'Database'), ('network_device', 'Network Device'), ('app', 'Application'), ('cloud', 'Cloud'), ('other', 'Other')], default='os', max_length=64, verbose_name='Category')),
